...
# Supprimer la colonne "is_fraud" si elle existe
if 'is_fraud' in anomalies_finales.columns:
    anomalies_finales = anomalies_finales.drop(columns=['is_fraud'])
...
# --- EXPORT CSV DES ANOMALIES FINALES ---
export_path = "C:/Users/bress/DOCUMENTS/Projet pythoon/anomalies_finales.csv"
anomalies_finales.to_csv(export_path, index=False)
print(f"\nFichier CSV des anomalies finales exporté vers : {export_path}")
